...
export default function Leap(props: any) {
    ...
    const [argument, setArgument] = useState(+(props.samples / 3).toFixed())
    ...
    return (
        <>
            <MenuItem onClick={handleClick} id={'jump'}>Задержанный единичный скачок</MenuItem>
