...
export default function ExpEnvelope(props: any) {
    ...
    const [ogib, setOgib] = useState(props.samples / 5)
    const [nesuch, setNesuch] = useState(25 / (Math.pow(10, (props.samples.toString().split('').length - 1))))
    ...
    return (
        <>
            <MenuItem onClick={handleClick} id={'exp_ogub'}>Сигнал с экспоненциальной огибающей</MenuItem>
