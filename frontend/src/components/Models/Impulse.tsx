...
export default function Impulse(props: any) {
    ...
    const [argument, setArgument] = useState<number>(+(props.samples / 3).toFixed())
    ...
    return (
        <>
            <MenuItem onClick={handleClick} id={'impulse'}>Задержанный единичный имульс</MenuItem>
