...
export default function Exponent(props: any) {
    ...
    const [argument, setArgument] = useState(0.99)
    ...
    return (
        <>
            <MenuItem onClick={handleClick} id={'exponent'}>Дискретизированная убывающая экспонента</MenuItem>
