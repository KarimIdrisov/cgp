...
export default function Meandr(props: any) {
    ...
    const [argument, setArgument] = useState(+(props.samples / 8).toFixed())
    ...
    return (
        <>
            <MenuItem onClick={handleClick} id={'meandr'}>«Меандр» с периодом L</MenuItem>
